...
import { Bot, Check, Key, Settings2, Sparkles } from "lucide-react";
import {
  useAISettingsStore,
  type AIProvider,
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            {/* OpenAI Key */}
            <div
              className={`space-y-2 ${settings.selectedProvider !== "openai" ? "opacity-50 hover:opacity-100 transition-opacity" : ""}`}
            >
              <Label
                htmlFor="openai-key"
            ...
            {/* Google Key */}
            <div
              className={`space-y-2 ${settings.selectedProvider !== "google" ? "opacity-50 hover:opacity-100 transition-opacity" : ""}`}
            >
              <Label
                htmlFor="google-key"
                className="flex items-center gap-2 text-xs"
            ...
            {/* Anthropic Key */}
            <div
              className={`space-y-2 ${settings.selectedProvider !== "anthropic" ? "opacity-50 hover:opacity-100 transition-opacity" : ""}`}
            >
              <Label
